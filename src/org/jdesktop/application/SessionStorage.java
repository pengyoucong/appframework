 ...
 * components with a {@link Component#getName name} and for
...
public class SessionStorage {
     ...
     * and the component has a {@link Component#getName name}, then
	 ...
	 */
		...
		if ((gcBounds0 != null) && (gcBounds0.equals(gcBounds1)) && (sc0 == sc1)) {
                    ...
                    if (resizable) {
						...
						if(bounds.x > 0 && bounds.y > 0 && bounds.x < (gcBounds0.width - bounds.width) && bounds.y < (gcBounds0.height - bounds.height)) {
							w.setBounds(bounds);
						}
                    }
		}
...
//                }
     ...
     *     {@link JComponent#getClientProperty client property} under
